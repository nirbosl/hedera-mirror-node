...
dependencies {
    ...
    val jooqVersion = "3.21.7" // Always make the version in project root build.gradle.kts match
    ...
    implementation("org.graalvm.buildtools:native-gradle-plugin:1.1.11")
